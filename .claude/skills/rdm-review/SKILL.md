...
2. **Read the acceptance criteria**:
   - For a phase: `rdm phase show <phase-number> --roadmap <slug> --project oidc-provider`
   - For a task: `rdm task show <slug> --project oidc-provider`
...
7. **Offer to create rdm tasks** for any actionable issues found:
   ```bash
   rdm task create <slug> --title "Review finding: description" --body "Details." --no-edit --project oidc-provider
   ```

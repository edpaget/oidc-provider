...
2. **Read the roadmap**: `rdm roadmap show <slug> --project oidc-provider` to get the overview and phase list.
...
4. **Read each phase**: `rdm phase show <stem> --roadmap <slug> --project oidc-provider --format json` for each phase. Collect titles, bodies, and commit SHAs.
